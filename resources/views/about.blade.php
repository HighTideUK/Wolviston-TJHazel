...
@section('content')
   ...
   <header class="blue">
	...
	<div class="header-message" data-aos="fade-up">
		...
		<div class="inner block-inner">
			...
			<div class="body right-block">
				...
				<p>From our offices in the North East and North West of England, our Structural and Civil Engineering Design and Detailing service provides exceptional Project Management and Project Controls, the combination of which means transformation is both measurable and impactful for each and every project.</p>
				...
				<p>The combination of our global expertise and local knowledge has seen us solve intricate design challenges all over the world. <a href="{{ route('casestudies') }}">Explore a selection of our ambitious and innovative projects here</a>. </p>
	...
	<div class="wide-image">
		<div class="inner block-inner">
			<img src="/images/team_photo.jpg" alt="" />
		</div>
	</div>
